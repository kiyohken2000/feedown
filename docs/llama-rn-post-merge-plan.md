...
- [ ] `npm view llama.rn version` が v0.12.3 超え、かつ #349 含有を確認
- [ ] フェーズ A: PoC を npm 版に戻して iOS A15 で embed ログ確認
- [ ] フェーズ B: iOS で Qwen3 0.6B / Gemma 4 E2B のベンチ取得
- [ ] フェーズ C: Android 実機で同ベンチ + #229 系 crash 有無
- [ ] フェーズ D: executorch と横並び比較表を埋める
- [ ] GO / NO-GO / 部分採用を判断、結論をこのドキュメント末尾に追記
