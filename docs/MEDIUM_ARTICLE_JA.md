# Feedlyがいつか終わるかもしれないから、自分でRSSリーダーを作った
...
![FeedOwn Web App - 記事一覧](web_screenshots/web_app_2.png)
...
![FeedOwn ログイン画面](web_screenshots/web_app_1.png)
*シンプルでクリーンなログイン画面*
...
![FeedOwn モバイルアプリ](mobile_screenshots/mobile_ss_articles1.PNG)
...
![リーダーモード](mobile_screenshots/mobile_ss_reader1.PNG)
*リーダーモードで記事の本文だけを抽出*
...
![ダークモード](mobile_screenshots/mobile_ss_articles2.PNG)
*深夜の読書にも優しい*
...
![フィード管理](web_screenshots/web_app_4.png)
*フィード購読の管理*
...
![お気に入り](web_screenshots/web_app_5.png)
*保存した記事は、永遠にあなたのもの*
