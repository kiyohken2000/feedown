...
export async function onRequestGet(context) {
    try {
        ...
        // Get all favorites
        const favorites = await listDocuments(`users/${uid}/favorites`, idToken, config, 1000);
        ...
        return new Response(JSON.stringify({ error: 'Failed to get favorites' }), { status: 500, headers: { 'Content-Type': 'application/json' } });
    }
}
