...
import { ReadLaterStacks } from '../stacks/ReadLaterStacks'
    ...
    >
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <FontIcon name="newspaper-o" color={color} size={size} />
          ),
        }}
      />
      <Tab.Screen
        name="ReadLaterTab"
        component={ReadLaterStacks}
        options={{
          tabBarLabel: 'Read Later',
          tabBarIcon: ({ color, size }) => (
            <FontIcon name="bookmark" color={color} size={size} />
          ),
        }}
      />
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Feeds',
          tabBarIcon: ({ color, size }) => (
            <FontIcon name="rss" color={color} size={size} />
          ),
        }}
      />
      <Tab.Screen
