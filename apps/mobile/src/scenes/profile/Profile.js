  ...
  return (
    <ScreenTemplate>
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        {/* On-Device AI (navigates to AiSettings screen) */}
        <View style={styles.section}>
          ...
          >
            <View style={{ flex: 1 }}>
              <Text style={[styles.toggleLabel, { color: theme.text }]}>AI Settings</Text>
              <Text style={[styles.toggleDescription, { color: theme.textMuted }]}>
                Summary, model selection, output language
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: fontSize.small, color: colors.gray, marginTop: 4 },
  actionButton: {
    backgroundColor: colors.white,
    borderRadius: 12,
    padding: 16,
