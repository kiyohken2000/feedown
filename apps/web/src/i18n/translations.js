export const translations = {
  en: {
    ...
    landing: {
      ...
      aiSubtitle: 'Powered by your device. Your articles never leave your phone.',
      aiDesc: 'FeedOwn runs a local LLM directly on your device — no API keys, no cloud, no data leaving your phone. Summarize articles, explore signals, chat, and translate, all offline.',
      aiFeature1Title: 'Article Summaries',
      aiFeature1Desc: 'Get concise summaries from multiple perspectives — brief, technical, or critical — in seconds.',
      aiFeature2Title: 'Signals',
      aiFeature2Desc: 'Surface hidden insights: key entities, sentiment, timeline, and important numbers in one tap.',
      aiFeature3Title: 'AI Chat',
      aiFeature3Desc: 'Ask questions about any article and get answers grounded in the text you just read.',
      aiFeature4Title: 'Translation',
      aiFeature4Desc: 'Translate foreign-language articles into your preferred language without leaving the app.',
      aiSettings: 'AI Settings',
      aiSummarize1: 'Summary (generating)',
      aiSummarize2: 'Summary (Japanese)',
      aiSummarize3: 'Summary (English)',
      aiSignals: 'Signals',
      aiChat: 'AI Chat',
      aiTranslation: 'Translation',
      aiPrivacyNote: 'All AI processing happens on-device using open-source LLMs via ExecuTorch. Requires iOS 17+ or Android 13+.',
      // Self-host
  ...
  ja: {
    ...
    landing: {
      ...
      // On-Device AI
      aiTitle: 'オンデバイスAI',
      aiSubtitle: 'あなたのデバイスで動く。記事データはスマホの外に出ない。',
      aiDesc: 'FeedOwnはローカルLLMをデバイス上で直接実行します。APIキー不要、クラウド不要、データは端末の外に出ません。要約・シグナル・チャット・翻訳がすべてオフラインで使えます。',
      aiFeature1Title: '記事要約',
      aiFeature1Desc: '簡潔・技術的・批判的など複数の視点から、数秒で要約を生成します。',
      aiFeature2Title: 'シグナル',
      aiFeature2Desc: '重要な固有表現・感情・時系列・数値など、記事に隠れた洞察をワンタップで抽出。',
      aiFeature3Title: 'AIチャット',
      aiFeature3Desc: '読んだ記事の内容をベースに、気になることを何でも質問できます。',
      aiFeature4Title: '翻訳',
      aiFeature4Desc: '外国語の記事をアプリを離れることなく、好みの言語に翻訳します。',
      aiSettings: 'AI設定',
      aiSummarize1: '要約（生成中）',
      aiSummarize2: '要約（日本語記事）',
      aiSummarize3: '要約（英語記事）',
      aiSignals: 'シグナル',
      aiChat: 'AIチャット',
      aiTranslation: '翻訳',
      aiPrivacyNote: 'すべてのAI処理はExecuTorchを使ったオープンソースLLMによりデバイス上で実行されます。iOS 17以上またはAndroid 13以上が必要です。',
      // Self-host
