export const translations = {
  en: {
    ...
    docs: {
      ...
      faq3A: 'Currently, you need to add feeds manually. OPML import is planned for a future release.',
    ...
    setup: {
      ...
      step2Title: 'Step 2: Set up Cloudflare Workers',
      step2Content: 'Deploy the RSS proxy worker that handles feed fetching and caching.',
      step3Title: 'Step 3: Deploy to Cloudflare Pages',
      step3Content: 'Build and deploy the web application to Cloudflare Pages.',
      step4Title: 'Step 4: Configure Environment Variables',
      step4Content: 'Set up the required environment variables in your Cloudflare Pages project.',
  ...
  ja: {
    ...
    docs: {
      ...
      faq3A: '現在、フィードは手動で追加する必要があります。OPMLインポートは将来のリリースで計画されています。',
      faq4Q: 'フィードに制限はありますか？',
    ...
    setup: {
      ...
      step2Title: 'ステップ2: Cloudflare Workersのセットアップ',
      step2Content: 'フィードの取得とキャッシュを処理するRSSプロキシワーカーをデプロイします。',
      step3Title: 'ステップ3: Cloudflare Pagesへのデプロイ',
      step3Content: 'WebアプリケーションをビルドしてCloudflare Pagesにデプロイします。',
      step4Title: 'ステップ4: 環境変数の設定',
      step4Content: 'Cloudflare Pagesプロジェクトで必要な環境変数を設定します。',
