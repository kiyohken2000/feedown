...
import { useTheme } from '../contexts/ThemeContext'; // ← ダークモード判定用に追加！
...
const Navigation = ({ unreadCount = 0 }) => {
  ...
  const styles = {
    // 👇 ここをオレンジからモノトーン（ダークモード対応）に変更したよ！
    nav: { backgroundColor: isDarkMode ? '#222' : '#333', padding: '0 1.5rem', boxShadow: '0 2px 4px rgba(0,0,0,0.15)', position: 'sticky', top: 0, zIndex: 100, height: '52px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
