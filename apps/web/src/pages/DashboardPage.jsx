...
const DashboardPage = () => {
  ...
  }, [fetchFeeds, fetchArticles, selectedFeedId]);
  ...
  }, [lastArticleFetchTime, fetchArticles, selectedFeedId]);
  ...
  const groupedArticles = useMemo(() => {
    ...
    return sorted;
  }, [filteredArticles, getFeedCategory]);
      ...
      <div style={{ display: 'flex', height: 'calc(100vh - 52px)', position: 'relative' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', marginLeft: sidebarPinned ? '0' : '12px' }}>
          ...
          <div style={{ padding: '0.5rem 1.5rem 1rem', flex: 1 }}>
            ...
            {!articlesError && filteredArticles.length === 0 && !articlesLoading && (
            ...
            {filteredArticles.length > 0 && hasMore && (
              <div style={{ padding: '2rem', display: 'flex', justifyContent: 'center' }}>
                <button
                  ...
                  disabled={loadingMore || articlesLoading}
                  style={{
                ...
                >
                  {loadingMore ? (
                    <>
                      <div style={{ width: '16px', height: '16px', border: '2px solid #f3f3f3', borderTop: '2px solid #FF6B35', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
                      Loading...
                    </>
                  ) : (
                    'Load More Articles'
