...
import { FaCheck, FaSync, FaArrowUp, FaList, FaTh, FaRss, FaThumbtack } from 'react-icons/fa';
      ...
      <div style={{ display: 'flex', height: 'calc(100vh - 52px)', position: 'relative' }}>
        ...
        >
          {sidebarOpen && (
            <>
              {/* ピンボタン */}
              <div style={{ padding: '0.75rem 1rem', display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                <button
                  onClick={() => setSidebarPinned(v => !v)}
                  title={sidebarPinned ? 'ピン解除' : 'サイドバーを固定'}
                  style={{
        ...
        <div style={{
          ...
          display: 'flex',
          flexDirection: 'column',
          marginLeft: sidebarPinned ? '0' : '12px', // トリガーの幅分
        }}>
