...
const ReadLaterPage = () => {
  ...
  const fetchArticles = useCallback(async () => {
    ...
    } catch (e) { setError('Failed to load Read Later articles.'); }
  ...
  const handleRefresh = useCallback(async () => {
    ...
    } catch (e) { setError('Failed to refresh.'); }
  ...
  const renderCard = (article) => {
    ...
    return (
      ...
      >
        ...
        {article.image_url ? <img src={article.image_url} alt="" style={{ width: '100%', height: '150px', objectFit: 'cover' }} />
  ...
  const renderListRow = (article, idx) => {
    ...
    return (
      ...
      >
        ...
        <span style={{ color: textSecondary, fontSize: '0.82rem', fontWeight: '600', minWidth: '100px', maxWidth: '150px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', flexShrink: 0, textAlign: 'left' }}>{article.feed_title || 'Feed'}</span>
  ...
  const renderMagazineRow = (article, idx) => {
    ...
    return (
      ...
      onMouseOut={e => { e.currentTarget.style.backgroundColor = 'transparent'; }}
      >
        {article.image_url ? <img src={article.image_url} alt="" style={{ width: '160px', height: '110px', objectFit: 'cover', borderRadius: '8px', flexShrink: 0 }} />
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: bg }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '1.5rem' }}>
        ...
        {(loading || refreshing) && <div style={{ textAlign: 'center', padding: '3rem' }}><div style={{ width: '32px', height: '32px', border: '4px solid #f3f3f3', borderTop: '4px solid #FF6B35', borderRadius: '50%', animation: 'spin 1s linear infinite', margin: '0 auto' }} /></div>}
